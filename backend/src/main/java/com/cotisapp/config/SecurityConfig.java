...
import com.cotisapp.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final OrganisationContextFilter orgContextFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAfter(twoFactorEnforcementFilter, OrganisationContextFilter.class);
        return http.build();
    }
