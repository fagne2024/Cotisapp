...
const POSTE_BY_KIND: Record<PosteKind, PosteMeta> = {
  ...
  tresorier_adj: {
    ...
    badgeClass: 'pb-tresorier-adj',
    icon: '💼',
  },
  commissaire: {
    kind: 'commissaire',
    label: 'Commissaire au compte',
    badgeClass: 'pb-commissaire',
    icon: '📊',
  },
...
const API_TO_KIND: Record<PosteMembreApi, PosteKind> = {
  ...
  TRESORIER: 'tresorier',
  TRESORIER_ADJOINT: 'tresorier_adj',
  COMMISSAIRE_AUX_COMPTES: 'commissaire',
...
const KIND_TO_API: Record<PosteKind, PosteMembreApi> = {
  ...
  tresorier: 'TRESORIER',
  tresorier_adj: 'TRESORIER_ADJOINT',
  commissaire: 'COMMISSAIRE_AUX_COMPTES',
  superviseur: 'SUPERVISEUR',
};
